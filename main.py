    ...
    def update_minimap(self):
        ...
        for location in locations_to_display:
            ...
            if isinstance(location, Room):
                self.minimap_canvas.create_rectangle(x_scaled, y_scaled, x_scaled + scale_factor, y_scaled + scale_factor, fill="gray", outline="black")  # Example: draw a gray square for each room
            elif isinstance(location, Building):
                self.minimap_canvas.create_rectangle(x_scaled, y_scaled, x_scaled + scale_factor * location.dimensions[0], y_scaled + scale_factor * location.dimensions[1], fill="lightblue", outline="black")  # Example: draw a lightblue rectangle for buildings
            elif isinstance(location, Town):
                self.minimap_canvas.create_rectangle(x_scaled, y_scaled, x_scaled + scale_factor * location.dimensions[0], y_scaled + scale_factor * location.dimensions[1], fill="lightgreen", outline="black")  # Example: draw a lightgreen rectangle for towns
        ...
        self.minimap_canvas.create_oval(player_x_scaled - 5, player_y_scaled - 5, player_x_scaled + 5, player_y_scaled + 5, fill="red", outline="black")  # Example: draw a red circle for the player
